...
#
# • Default IPv6 routes:
#      alfa   → default via db11::1 (Athos neighbour)
#      beta   → default via db22::1 (Aramis neighbour)
#
...
# -----------------------------------------------------------------
# 0️⃣ Global settings – abort on error, echo every command
# -----------------------------------------------------------------
set -euo pipefail
set -x

# -----------------------------------------------------------------
# 1️⃣ Clean‑up – delete namespaces, veth interfaces and tmux session
# -----------------------------------------------------------------
cleanup() {
...
# -----------------------------------------------------------------
# 2️⃣ Create namespaces and bring up loopback
# -----------------------------------------------------------------
for ns in alfa athos porthos aramis beta; do
    ip netns add "$ns"
...
# -----------------------------------------------------------------
# 3️⃣ Create veth pairs (named for readability)
# -----------------------------------------------------------------
# alfa ↔ athos
...
# -----------------------------------------------------------------
# 4️⃣ Assign IPv6 addresses and bring interfaces up
# -----------------------------------------------------------------
# alfa → athos
...
# -----------------------------------------------------------------
# 5️⃣ Enable IPv6 forwarding (all nodes act as routers)
# -----------------------------------------------------------------
for ns in alfa athos porthos aramis beta; do
...
# -----------------------------------------------------------------
# 6️⃣ IOAM‑6 IDs + enable IOAM‑6 on the interfaces that got an ID
# -----------------------------------------------------------------
# athos
...
# -----------------------------------------------------------------
# 7️⃣ IOAM namespace data (per‑namespace)
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# 8️⃣ Add the two special routes (plain IPv6)
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# 9️⃣ Encapsulation route on athos (IOAM‑6)
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# 10️⃣ Default IPv6 routes for edge hosts
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# 11️⃣ Start tmux (one window per node, mouse enabled)
# -----------------------------------------------------------------
SESSION="nettopo"
